<?php
  ...
  if (isset($_POST['username']) && isset($_POST['password'])) {
    ...
    if (user_login($_POST['username'], $_POST['password']) == TRUE) {
      ...
      header( 'Location: index.php?option=home_login' );
    }
    //else include("exception.php");
  }
            ...
            <div id="wrapper">
                <div id="steps">
			     ...
			     <p><a href="register.html">Create a new account</a></p>
                             <p>In case of any difficulties send an email to <br/><strong>webadmin@railways.org</strong>
                             </p>   
                             <p>
                                AAOC C331 - Data Processing Project
                             </p>                            
